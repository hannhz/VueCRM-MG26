  ...
  >
    ...
    <div class="flex-1 min-h-0 overflow-auto custom-scrollbar">
      <table class="w-full border-collapse">
        <thead
          class="sticky top-0 bg-white z-10 shadow-[0_1px_0_0_rgba(0,0,0,0.05)]"
        >
          <tr class="border-b border-gray-200">
            ...
            <th
              class="px-6 py-4 text-left text-[11px] font-bold text-gray-400 uppercase tracking-wider"
            >
            ...
            <th
              class="px-6 py-4 text-left text-[11px] font-bold text-gray-400 uppercase tracking-wider w-40"
            >
              <div class="flex items-center gap-2">
                Stage
                <ChevronDown :size="14" />
