...
<template>
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      ...
      <main class="flex-1 p-4 bg-light-base overflow-y-auto">
        ...
        <!-- Action Bar -->
        <div
          class="bg-white rounded-lg shadow-sm h-147 p-4 border border-outline"
        >
              ...
              <table class="w-full">
                ...
                <tbody>
                  ...
                  <tr v-if="contacts.length === 0">
                    <td
                      colspan="7"
                      class="px-6 py-20 text-center text-sub-text"
                    >
