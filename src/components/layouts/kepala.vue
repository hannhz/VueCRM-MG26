...
<template>
  <header
    class="h-16 bg-white shadow-sm flex items-center justify-between px-8"
  >
    <div class="relative w-64">
      ...
      <input
        ...
        class="pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
      />
    </div>
    ...
    <div class="flex items-center gap-4">
      ...
      <div class="flex items-center gap-3 cursor-pointer hover:bg-gray-50 rounded-lg px-3 py-2 transition">
        <div class="flex items-center gap-3">
          ...
          <!-- User Info -->
          <div class="text-left">
            <p class="text-sm font-semibold text-gray-800">Thomas Anree</p>
