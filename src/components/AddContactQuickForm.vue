          ...
          <form @submit.prevent="handleSubmit" class="p-6 space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <input v-model="formData.jobTitle" type="text" placeholder="Job Title"
                  class="w-full px-3 py-2 border border-outline rounded-lg focus:outline-none focus:ring-1 focus:ring-sub-text text-sm" />
              </div>
              <div>
                <label class="block text-sm font-medium text-dark-base mb-2">Owner</label>
                <input v-model="formData.owner" type="text" placeholder="Owner"
                  class="w-full px-3 py-2 border border-outline rounded-lg focus:outline-none focus:ring-1 focus:ring-sub-text text-sm" />
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <input v-model="formData.email" type="email" placeholder="youremail@gmail.com"
                  class="w-full px-3 py-2 border border-outline rounded-lg focus:outline-none focus:ring-1 focus:ring-sub-text text-sm" />
              </div>
              <div>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <input v-model="formData.telephone" type="text" placeholder="+62123456789"
                  class="w-full px-3 py-2 border border-outline rounded-lg focus:outline-none focus:ring-1 focus:ring-sub-text text-sm" />
              </div>
              <div>
                <label class="block text-sm font-medium text-dark-base mb-2">Telephone</label>
                <input v-model="formData.mobile" type="text" placeholder="+62123456789"
                  class="w-full px-3 py-2 border border-outline rounded-lg focus:outline-none focus:ring-1 focus:ring-sub-text text-sm" />
              </div>
            </div>
